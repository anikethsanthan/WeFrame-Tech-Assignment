    ...
    <div className='flex'>
      {cardData.map((card) => (
        <div key={card.id} className='w-[330px] h-[438px] mr-[24px] rounded-[8px] group'>
          ...
          <div className='bg-white cursor-pointer ml-[8px] mr-[8px] rounded-md pt-2 pb-2 hover:scale-105 flex justify-between -mt-[3.75rem] mb-[1.75rem] pl-[20px] pr-[20px] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
